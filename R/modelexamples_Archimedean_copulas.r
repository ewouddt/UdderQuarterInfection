...
#'\itemize{
#'\item \code{onestageparamatric} for the 1-stage parametric estimation
#'\item \code{twostageparametric} for the 2-stage parametric estimation
#'\item \code{twostagesemiparametric} for the 2-stage semiparametric estimation
#'}
#'These 3 list elements all contain the following items:
#'\itemize{
#'\item \code{estimate}: contains all parameter estimates for all models (model 0, model 1, model 2 and model 3)
#'\item \code{LLH}: contains the maximum likelihood for all models (model 0, model 1, model 2 and model 3)
#'}
#'
#'@section R Code for Model :
#'The source R code for this model can found:
#'\itemize{
#'\item in the \code{doc/R_Code_ArchimedeanCopulas.R} file in the package installation folder.
#'\item by accessing the function by calling \code{ArchimedeanCopulas} (without brackets) or \code{getAnywhere("ArchimedeanCopulas")}.
#'}
#'
#' @examples
#' \dontrun{
...
#========================================================#
# Authors: Leen Prenen, Roel Braeckers and Luc Duchateau #
#========================================================#

#====================================#
# read data and prepare output object#
#====================================#
...
# Questions:
# - add LLH to estimates?
# - stderror is a slot like estimate, but temporarily removed atm
# - remove selected piece of script?
